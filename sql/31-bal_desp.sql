...
(
    ...
    dotacao_inicial decimal(11, 2),
    atualizacao_monetaria decimal(11, 2),
    credito_suplementar decimal(11, 2),
    credito_especial decimal(11, 2),
    credito_extraordinario decimal(11, 2),
    reducao_dotacao decimal(11, 2),
    valor_empenhado decimal(11, 2),
    valor_liquidado decimal(11, 2),
    valor_pago decimal(11, 2),
    transferencia decimal(11, 2),
    transposicao decimal(11, 2),
    remanejamento decimal(11, 2),
    dotacao_atualizada decimal(11, 2),
    saldo_dotacao decimal(11, 2),
    valor_limitado decimal(11, 2),
    valor_recomposto decimal(11, 2),
    saldo_disponivel decimal(11, 2),
...
select
    ...
    round(cast(substring(raw_data, 32, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 45, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 58, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 71, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 84, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 97, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 136, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 149, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 162, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 175, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 188, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 218, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 231, 13) as decimal(11, 2)) / 100, 2),
    round(cast(substring(raw_data, 244, 13) as decimal(11, 2)) / 100, 2),
